...
class TestSujetsServices {



    public static function initialisationTest()
    {
        $evaluationsSujets = Evaluations::where('is_finish', false)->where('user_id', Auth::user()->id);
    ...
    {
        $updateTestGeneral = Evaluations::where('is_finish', false)->where('user_id', Auth::user()->id)
            ->update([
                "is_finish" => true,
            ]);
    ...
    public static function getEvaluationByUser(){
     $evaluationsSujets = Evaluations::where('is_finish', false)
