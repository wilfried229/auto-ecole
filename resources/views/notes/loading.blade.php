...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{$UserNameByChapitresSujet->libelle}} ({{date('d/M/Y',strtotime($UserNameByChapitresSujet->created_at))}})</h1>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <a href="{{route('corriger.user',$UserNameByChapitresSujet->sujet_id)}}" type="submit" class="btn btn-info" title="cliquez ici pour voir la correction">Voir la Corretion</a>
                    </div>
