...
<section class="content" >
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <a href="{{route('chapitre.listes')}}" class="small-box-footer">Cliquer ici <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-6">
        ...
        <a href="{{route('test.sujet38')}}" class="small-box-footer">Cliquer ici <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <a href="{{route('test.generales',0)}}" class="small-box-footer"> Cliquer ici<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
