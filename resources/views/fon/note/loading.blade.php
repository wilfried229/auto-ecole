    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ $UserNameByChapitresSujet->libelle  ?? ""}}
                            ({{ date('d/M/Y', strtotime($UserNameByChapitresSujet->created_at)) }})</h1>
                        <h1 class="m-0 text-dark">{{ $UserNameByChapitresSujet->sujet }} </h1>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    ...
                                    Candidat: {{ $UserNameByChapitresSujet->users()->first()->name }} {{ $UserNameByChapitresSujet->users()->first()->prenom }}
                                </h3>
                                ...
                                <div class="row">
                                    <div class="col-6 col-md-4 text-center">
                                        ...
                                        @if (is_null($note))
                                            ...
                                            <p class="text text-info">Veuillez Prendre soin de bien revoir les questions que
                                                vous aviez ratées et revenez améliorer votre niveau</p>
                                        @else
