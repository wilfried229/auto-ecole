...
<section class="content">
        ...
        <div class="col-lg-12">
                        <div class="card card-info">
                                <div class="card-header">
                                    ...
                                    {{-- {{$loop->iteration}} --}}
                                <h3 class="card-title">Chapitres {{$chapitre->titre}} ({{$chapitre->libelle}}) Sujet N°
                                    <br>Question N°
      ...
      <div class="container">
        ...
        <div class="row">
                ...
                <div class="col-md-4" id="alert-reponse">
                    ...
                    @if ($list->img != null)
                    <img src="{{asset('storage/audios/questions/img/'.$list->img)}}" alt="" srcset="" >
                                      ...
                                      <div class="input-group">
                                        ...
                                        @endif
                                             ...
                                             <input type="hidden" name="" id="reponse" value="{{$q->reponse}}">
                                                    ...
                                                    <input type="hidden" name="" id="pages" value="{{$listQuestion->currentPage()}}">
    ...
    <div class="row">
        ...
        @if (!empty($r->titre))
        <input type="hidden" name="" id="titre" value="{{$r->titre}}">
        <input type="hidden" name="" id="question" value="{{$r->question_id}}">
        {{-- <input type="hidden" name="" id="reponse" value="{{$r->reponse}}"> --}}
