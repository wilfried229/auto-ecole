        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card card-info">
                        <div class="card-header">
                            ...
                            {{-- {{$loop->iteration}} --}}
                            <h3 class="card-title">Sujet N°{{ $sujet_id }}
                                <br>Question N°
            ...
            <form id="submitQuestion">
                ...
                <div class="row">
                    ...
                    @if ($listQuestion->currentPage() == 20)
                    <div class="col-lg-2">
                        <a href="#" id="linkFin" class="btn btn-warning">Question Suivante</a>
                    </div>
                    @else
                    <div class="col-lg-2">
                        <a id="link" href="{{ $listQuestion->nextPageUrl() }}" class="btn btn-warning">Question Suivante</a>
                    </div>
                    @endif
                    ...
                    <input type="hidden" name="" id="sujetId" value="{{ $sujet_id }}">
                    @endforeach
